        ...
        <div className="mt-16 bg-slate-900 rounded-3xl p-8 md:p-12 text-center text-white shadow-xl">
          ...
          <form className="flex max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="bg-slate-800 text-white px-4 py-3 rounded-l-lg w-full focus:outline-none focus:ring-2 focus:ring-amber-500 border border-slate-700"
            />
            <button type="submit" className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-r-lg font-bold transition-colors">
              Subscribe
            </button>
          </form>
        </div>
